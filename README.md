...
> 🔗 Projeto no Sonar Cloud: [https://sonarcloud.io/summary/overall?id=FIAP-SOAT-TECH-TEAM_videocore-auth&branch=main](https://sonarcloud.io/summary/overall?id=FIAP-SOAT-TECH-TEAM_videocore-auth&branch=main)<br>
